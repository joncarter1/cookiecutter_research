"""Broken utilities module.

The code in this file should raise a variety of errors, highlighting the benefits of using tools like ruff and mypy.

To run the tests, run `uv run pytest tests/test_broken_utils.py`.
"""
...
def add_one(a: int) -> str:  # mypy will raise an error - bad type hints.
